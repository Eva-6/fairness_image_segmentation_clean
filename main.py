...
if __name__ == "__main__":
    ...
    f_all, h_all, y_all, g_all, sample_ids, group_names = (
        dict_stomach["f"],
        dict_stomach["h"],
        dict_stomach["y"],
        dict_stomach["g"],
        dict_stomach["sample_ids"],
        dict_stomach["group_names"],
    )
    ...
    idx_train, idx_temp = train_test_split(
        np.arange(len(f_all)), test_size=0.4, random_state=42
    )
    ...
    f_train, h_train, y_train, groups_train, sample_ids_train = (
        f_all[idx_train],
        h_all[idx_train],
        y_all[idx_train],
        g_all[idx_train],
    ...
    f_val, h_val, y_val, groups_val, sample_ids_val = (
        f_all[idx_val],
        h_all[idx_val],
        y_all[idx_val],
        g_all[idx_val],
    ...
    f_test, h_test, y_test, groups_test, sample_ids_test = (
        f_all[idx_test],
        h_all[idx_test],
        y_all[idx_test],
        g_all[idx_test],
    ...
    plot_convergence_algorithm(
        fsb,
        save_path=f"./output/convergence_plot_stomach_{param_fsb}.png",
        name_task="Stomach",
    )
