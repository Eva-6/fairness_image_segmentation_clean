...
from batchgenerators.transforms import (Compose, DataChannelSelectionTransform,
                                        GammaTransform, MirrorTransform,
...
from nnunet.training.data_augmentation.custom_transforms import (
    ...
    ConvertSegmentationToRegionsTransform, MaskTransform, RemoveKeyTransform)
